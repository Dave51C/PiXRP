...
def get_camera_parameters ():
    """
    Create a dictionary of all the camer parameters for the cameras in frc.json 
    """
    import json
    import numpy as np
    USB_Cams = open('frc.json','r')
...
def Find_Apriltags (TagIDs,img, TagsSeen, USBcam_mtx, USBcam_dist, FudgeOffset, FudgeFactor, Source):
    ...
    from PiggyVisionXRP import rotate, CORNERS, TAG_SPECS, REEF_TAGS, SWEETSPOT, CAMERA_OFFSET, ROBOT_OFFSET
    import time
    import cv2
    import numpy as np
